...
namespace Flowise
{
    public partial interface IUpsertHistoryClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Flowise.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Flowise.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Flowise.UpsertHistoryResponse>>> GetAllUpsertHistoryAsResponseAsync(
            string id,
            global::Flowise.GetAllUpsertHistoryOrder? order = default,
            global::System.DateTime? startDate = default,
            global::System.DateTime? endDate = default,
