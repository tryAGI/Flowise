...
namespace Flowise
{
    public partial interface ILeadsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Flowise.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Flowise.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Flowise.Lead>>> GetAllLeadsForChatflowAsResponseAsync(
            string id,
            global::Flowise.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
